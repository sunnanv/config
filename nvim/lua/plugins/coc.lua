...
--            keyset("n", "gd", ":Telescope coc definitions<cr>", { silent = true })
--            keyset("n", "gD", ":Telescope coc declarations<cr>", { silent = true })
--            keyset("n", "gt", ":Telescope coc type_definitions<cr>", { silent = true })
...
--            keyset("n", "<leader>f", ":OR<cr>:Format<cr>", { silent = true })
...
--            keyset("n", "<leader>d", ":TeleScope coc diagnostics<cr>", opts)
--            -- keyset("n", "<space>a", ":<C-u>CocList diagnostics<cr>", opts)
--            -- Manage extensions
--            keyset("n", "<space>e", ":<C-u>CocList extensions<cr>", opts)
--            -- Show commands
--            -- keyset("n", "<space>c", ":<C-u>CocList commands<cr>", opts)
--            keyset("n", "<leader>c", ":Telescope coc commands<cr>", opts)
